  ...
  return (
    <div className='h-screen shadow-md border'>
        ...
        <div className='fixed bottom-7 p-6 w-64 '>
            ...
            <h2 className='text-sm mt-2 text-gray-600'><strong>{formList?.length} </strong>Out of <strong>3</strong> Fichier créé</h2>
            <h2 className='text-sm mt-3 text-gray-600'>Mettez à jour votre plan pour la construction d'une forme d'IA illimitée</h2>
